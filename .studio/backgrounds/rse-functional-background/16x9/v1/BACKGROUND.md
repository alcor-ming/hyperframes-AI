---
{
  ...
  "duration_range": {
    ...
    "default_seconds": 48,
    "max_seconds": 48,
    "hero_hold_seconds": 46.8
  },
  "entry_contract": {
    "requires": [
      "empty_full_frame_stage"
    ],
    "accepts": "A 1920x1080 composition that needs a continuous background field."
  },
  "exit_contract": {
    "provides": [
      "stable_environment",
  ...
  "artifact": {
    ...
    "project": "Hyperframes",
    "file": "compositions/rse-functional-background.html",
    "revision": 1,
    "sha256": "4e3c88e82e1c66a0915dedcd5c3792994a5f24983ffccb2d12fc24e56b7d24dc"
  }
}
---

# rse-functional-background/16x9@v1
